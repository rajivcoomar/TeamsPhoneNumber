    ...
    public class SyncTeamMembersActivity
    {
            ...
            ILogger log)
        {
            ...
            try
            {
                ...
                var recipients = await this.GetRecipientsAsync(notificationData, userEntities);
        ...
        private async Task<IEnumerable<SentNotificationDataEntity>> GetRecipientsAsync(NotificationDataEntity notification, IEnumerable<UserDataEntity> users)
        {
            ...
            await Task.WhenAll(users.ForEachAsync(maxParallelism, async user =>
            {
                ...
                recipients.Add(user.CreateInitialSentNotificationDataEntity(notification: notification));
            }));
