...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Controllers
{
    ...
    public class DraftNotificationsController : ControllerBase
    {
        ...
        private readonly LanguageTranslateOptions languageTranslateOptions;
        ...
        /// <param name="languageTranslateOptions">language Translate Options</param>
        public DraftNotificationsController(
            ...
            IOptions<LanguageTranslateOptions> languageTranslateOptions)
        {
            ...
            this.languageTranslateService = languageTranslateService ?? throw new ArgumentException(nameof(languageTranslateService));
            this.languageTranslateOptions = languageTranslateOptions?.Value ?? throw new ArgumentNullException(nameof(languageTranslateOptions));
        }
        ...
        public async Task<ActionResult<string>> CreateDraftNotificationAsync([FromBody] DraftNotification notification)
        {
            ...
            var spanishLang = await this.languageTranslateService.TranslateTextRequest(
                this.languageTranslateOptions.Region,
                this.languageTranslateOptions.SubscriptionKey,
                this.languageTranslateOptions.Endpoint,
                notificationEntity);
        ...
        public async Task<IActionResult> DuplicateDraftNotificationAsync(string id)
        {
            ...
            var notificationId = await this.notificationDataRepository.DuplicateDraftNotificationAsync(notificationEntity, createdBy);

            notificationEntity.RowKey = notificationId;
            var spanishLang = await this.languageTranslateService.TranslateTextRequest(
                            this.languageTranslateOptions.Region,
                            this.languageTranslateOptions.SubscriptionKey,
                            this.languageTranslateOptions.Endpoint,
        ...
        public async Task<ActionResult<DraftNotification>> GetDraftNotificationByIdAsync(string id)
        {
            ...
            var result = new DraftNotification
            {
                ...
                MessageType = string.IsNullOrEmpty(notificationEntity.MessageType) ? "TeamsOnly" : notificationEntity.MessageType,
            };
