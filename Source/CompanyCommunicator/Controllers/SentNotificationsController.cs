...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Controllers
{
    ...
    public class SentNotificationsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetSentNotificationByIdAsync(string id)
        {
            ...
            var msgTypeText = "Teams Only";
            if (!string.IsNullOrEmpty(notificationEntity.MessageType))
            {
                switch (notificationEntity.MessageType)
                {
                    case "TeamsOnly":
                        msgTypeText = "Teams Only";
                        break;
                    case "SMSOnly":
                        msgTypeText = "SMS Only";
                        break;
                    case "Both":
                        msgTypeText = "Both";
                        break;
                    case "TeamsthenSMS":
                        msgTypeText = "Teams Then SMS";
                        break;
                    default:
                        msgTypeText = "Teams Only";
                        break;
            ...
            var result = new SentNotification
            {
                ...
                CreatedBy = notificationEntity.CreatedBy,
                MessageType = msgTypeText, // string.IsNullOrEmpty(notificationEntity.MessageType) ? "Teams Only" : notificationEntity.MessageType,
            };
