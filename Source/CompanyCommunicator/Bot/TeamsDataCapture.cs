...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Bot
{
    ...
    public class TeamsDataCapture
    {
        ...
        private readonly ICustomUserReplyService customUserReplyService;
        private readonly ICustomAppSettingsService customAppSettingsService;
        ...
        /// <param name="customUserReplyService">Custom User Reply service.</param>
        public TeamsDataCapture(
            ITeamDataRepository teamDataRepository,
            IUserDataService userDataService,
            IAppSettingsService appSettingsService,
            ICustomUserReplyService customUserReplyService,
            ICustomAppSettingsService customAppSettingsService)
        {
            ...
            this.customUserReplyService = customUserReplyService ?? throw new ArgumentNullException(nameof(customUserReplyService));
            this.customAppSettingsService = customAppSettingsService ?? throw new ArgumentNullException(nameof(customAppSettingsService));
        }
        ...
        /// <summary>
        /// Update custom reply information in the table storage.
        /// </summary>
        /// <param name="activity">Message instance.</param>
        /// <returns>A task that represents the work queued to execute.</returns>
        public async Task<string> OnCustomReplyUpdateAsync(IMessageActivity activity)
        {
            return await this.customUserReplyService.SaveCustomReplyAsync(activity);
        }
        ...
        /// <returns>A task that represents the work queued to execute.</returns>
        public async Task<string> GetMessage(string rowKey)
        {
            return await this.customAppSettingsService.GetMessageAsync(rowKey);
        }
