...
namespace Microsoft.Teams.Apps.CompanyCommunicator
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddOptions<LanguageTranslateOptions>()
                .Configure<IConfiguration>((options, configuration) =>
                {
                    options.Region =
                        configuration.GetValue<string>("CognitiveRegion");

                    options.SubscriptionKey =
                        configuration.GetValue<string>("CognitiveSubscriptionKey");

                    options.Endpoint =
                        configuration.GetValue<string>("CognitiveEndpoint");
                });
            ...
            services.AddSingleton<ICustomUserReplyRepository, CustomUserReplyRepository>();
            services.AddSingleton<ICustomAppConfigRepository, CustomAppConfigRepository>();
            services.AddSingleton<ICustomMessageLocaleRepository, CustomMessageLocaleRepository>();
            ...
            services.AddTransient<ICustomUserReplyService, CustomUserReplyService>();
            services.AddTransient<ICustomAppSettingsService, CustomAppSettingsService>();
            services.AddTransient<ILanguageTranslateService, LanguageTranslateService>();
