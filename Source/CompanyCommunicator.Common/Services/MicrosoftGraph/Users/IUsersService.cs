...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Common.Services.MicrosoftGraph
{
    ...
    public interface IUsersService
    {
        ...
        Task<(IEnumerable<User>, string)> GetAllUsersAsync(string messageType, string deltaLink = null);
        ...
        /// <summary>
        /// Get users presence activty.
        /// </summary>
        /// <param name="userId">User's AAD id.</param>
        /// <returns>returns presence activity</returns>
        // Task<string> GetUserPresence(string userId);
