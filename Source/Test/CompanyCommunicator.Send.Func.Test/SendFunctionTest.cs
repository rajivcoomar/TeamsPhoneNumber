...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Send.Func.Test
{
    ...
    public class SendFunctionTest
    {
        ...
        private readonly Mock<ICustomUserReplyService> customUserReplyService = new Mock<ICustomUserReplyService>();
        ...
        {
            // Arrange
            Action action1 = () => new SendFunction(null /*options*/, this.notificationService.Object, this.messageService.Object, this.notificationRepo.Object, this.sendQueue.Object, this.localizer.Object, this.memoryCache.Object, this.customUserReplyService.Object);
            Action action2 = () => new SendFunction(this.options, null /*notificationService*/, this.messageService.Object, this.notificationRepo.Object, this.sendQueue.Object, this.localizer.Object, this.memoryCache.Object, this.customUserReplyService.Object);
            Action action3 = () => new SendFunction(this.options, this.notificationService.Object, null /*messageService*/, this.notificationRepo.Object, this.sendQueue.Object, this.localizer.Object, this.memoryCache.Object, this.customUserReplyService.Object);
            Action action4 = () => new SendFunction(this.options, this.notificationService.Object, this.messageService.Object, null /*notificationRepo*/, this.sendQueue.Object, this.localizer.Object, this.memoryCache.Object, this.customUserReplyService.Object);
            Action action5 = () => new SendFunction(this.options, this.notificationService.Object, this.messageService.Object, this.notificationRepo.Object, null /*sendQueue*/, this.localizer.Object, this.memoryCache.Object, this.customUserReplyService.Object);
            Action action6 = () => new SendFunction(this.options, this.notificationService.Object, this.messageService.Object, this.notificationRepo.Object, this.sendQueue.Object, null /*localizer*/, this.memoryCache.Object, this.customUserReplyService.Object);
            Action action7 = () => new SendFunction(this.options, this.notificationService.Object, this.messageService.Object, this.notificationRepo.Object, this.sendQueue.Object, this.localizer.Object, this.memoryCache.Object, this.customUserReplyService.Object);
        ...
        {
            return new SendFunction(this.options, this.notificationService.Object, this.messageService.Object, this.notificationRepo.Object, this.sendQueue.Object, this.localizer.Object, this.memoryCache.Object, this.customUserReplyService.Object);
        }
    }
}
